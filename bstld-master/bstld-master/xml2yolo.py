...
parentpath = 'D:/TrafficLightTrainingDataset/' #"Directory path with parent dir before xml_dir or img_dir"
addxmlpath = parentpath + 'Xmls' #"Directory path with XML files"
addimgpath = parentpath + 'Images' #"Directory path with IMG files"
outputpath = parentpath + 'Output' #"output folder for yolo format"
classes_txt = 'D:/TrafficLightTrainingDataset/Classes.txt' #"File containing classes"
...
for xmlPath in xmlPaths:
    ...
    with open(outputpath + "/" + os.path.basename(xmlPath)[:-4] + ".txt", "w") as f:
        for shape in shapes:
            ...
            class_idx = 0 #Same class for all objects
